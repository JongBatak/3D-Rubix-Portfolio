        ...
        <header className="hero-nav pointer-events-auto flex items-center justify-between rounded-2xl border border-black/10 bg-black/5 px-4 py-3 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <Icon>
                <svg viewBox="0 0 24 24" fill="none" className="size-5">
                  <path d="M21 13.02A9 9 0 1 1 10.98 3a7 7 0 1 0 10.02 10.02Z" stroke="currentColor" strokeWidth="1.7" />
                </svg>
              </Icon>
            </button>
            <button
            ...
            >
              ...
              <Icon>
                <svg viewBox="0 0 24 24" fill="none" className="size-5">
                  <path d="M14.8 18a3 3 0 0 1-5.6 0M18 8a6 6 0 1 0-12 0c0 7-3 8-3 8h18s-3-1-3-8Z" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </Icon>
            </button>
            <button
            ...
            >
              <Icon>
                <svg viewBox="0 0 24 24" fill="none" className="size-5">
                  <path d="m12 3 2.9 5.87 6.48.94-4.69 4.57 1.11 6.46L12 17.77l-5.8 3.05 1.11-6.46-4.69-4.57 6.48-.94L12 3Z" fill="currentColor" />
                </svg>
              </Icon>
              986
            </button>
        ...
        <main className="grid flex-1 grid-cols-1 items-center gap-10 py-8 lg:grid-cols-[1fr_1.15fr] lg:gap-8">
          ...
          <div className="hero-copy pointer-events-auto max-w-xl space-y-4 text-[#121212]">
            ...
            <div className="hero-cta space-y-4 pt-5">
              <a href="#" className="inline-flex items-center gap-2 rounded-xl border border-black/25 bg-[#141414] px-6 py-3 text-sm font-extrabold uppercase tracking-wide text-[#ffd469] transition hover:-translate-y-0.5 hover:bg-black">
                <Icon>
                  <svg viewBox="0 0 24 24" fill="none" className="size-5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <a href="#" className="rounded-lg border border-black/30 bg-white/50 px-4 py-2 text-sm font-bold text-black transition hover:bg-white/70">
                  Hire Me
                </a>
                <a href="#" aria-label="X" className="rounded-lg border border-black/30 bg-white/45 p-2.5 text-black transition hover:bg-white/70">
                  <Icon>
                    <svg viewBox="0 0 24 24" fill="none" className="size-5">
                      <path d="M4 4 20 20M20 4 4 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                    </svg>
                  </Icon>
                </a>
                <a href="#" aria-label="GitHub" className="rounded-lg border border-black/30 bg-white/45 p-2.5 text-black transition hover:bg-white/70">
                  <Icon>
                    <svg viewBox="0 0 24 24" fill="none" className="size-5">
                      <path d="M12 2a10 10 0 0 0-3.16 19.49c.5.1.68-.21.68-.48v-1.85c-2.78.6-3.37-1.18-3.37-1.18-.46-1.15-1.11-1.46-1.11-1.46-.9-.61.07-.6.07-.6 1 .07 1.53 1.04 1.53 1.04.89 1.52 2.34 1.08 2.91.82.1-.66.35-1.08.64-1.33-2.22-.25-4.56-1.1-4.56-4.91 0-1.08.39-1.96 1.03-2.65-.1-.26-.45-1.28.1-2.67 0 0 .84-.27 2.75 1.02a9.7 9.7 0 0 1 5 0c1.91-1.29 2.75-1.02 2.75-1.02.55 1.39.2 2.41.1 2.67.64.69 1.03 1.57 1.03 2.65 0 3.82-2.34 4.66-4.57 4.9.36.31.68.9.68 1.8v2.67c0 .27.18.58.69.48A10 10 0 0 0 12 2Z" fill="currentColor" />
                    </svg>
                  </Icon>
                </a>
                <a href="#" aria-label="LinkedIn" className="rounded-lg border border-black/30 bg-white/45 p-2.5 text-black transition hover:bg-white/70">
                  <Icon>
                    <svg viewBox="0 0 24 24" fill="none" className="size-5">
                      <path d="M6.94 8.5A1.56 1.56 0 1 1 6.94 5.39 1.56 1.56 0 0 1 6.94 8.5ZM5.6 10.1h2.7V19H5.6v-8.9ZM10 10.1h2.58v1.22h.04c.36-.68 1.24-1.4 2.56-1.4 2.73 0 3.23 1.8 3.23 4.14V19h-2.7v-4.35c0-1.04-.02-2.37-1.44-2.37-1.45 0-1.67 1.13-1.67 2.3V19H10v-8.9Z" fill="currentColor" />
                    </svg>
                  </Icon>
                </a>
              </div>
